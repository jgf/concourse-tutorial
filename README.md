...
* [01 - Hello World task](https://github.com/jgf/concourse-tutorial#01---hello-world-task)
* [02 - Task inputs](https://github.com/jgf/concourse-tutorial#02---task-inputs)
* [03 - Task scripts](https://github.com/jgf/concourse-tutorial#03---task-scripts)
* [04 - Basic pipeline](https://github.com/jgf/concourse-tutorial#04---basic-pipeline)
* [05 - Tasks extracted into Resources](https://github.com/jgf/concourse-tutorial#05---tasks-extracted-into-resources)
* [06 - View job output in terminal](https://github.com/jgf/concourse-tutorial#06---view-job-output-in-terminal)
* [07 - Trigger jobs with the Concourse API](https://github.com/jgf/concourse-tutorial#07---trigger-jobs-with-the-concourse-api)
* [08 - Triggering jobs with resources](https://github.com/jgf/concourse-tutorial#08---triggering-jobs-with-resources)
* [09 - Destroying pipelines](https://github.com/jgf/concourse-tutorial#09---destroying-pipelines)
* [10 - Using resource inputs in job tasks](https://github.com/jgf/concourse-tutorial#10---using-resource-inputs-in-job-tasks)
* [11 - Passing task outputs to another task](https://github.com/jgf/concourse-tutorial#11---passing-task-outputs-to-another-task)
* [12 - Publishing outputs](https://github.com/jgf/concourse-tutorial#12---publishing-outputs)
* [13 - Actual pipeline - passing resources between jobs](https://github.com/jgf/concourse-tutorial#13---actual-pipeline---passing-resources-between-jobs)
* [14 - Parameterized pipelines](https://github.com/jgf/concourse-tutorial#14---parameterized-pipelines)

The following sections are found in subfolders of this repository and the tutorial continues in their README:

* [15 - Deploy application to Cloud](https://github.com/jgf/concourse-tutorial/tree/master/15_deploy_cloudfoundry_app)
* [16 - Run tests, then deploy application](https://github.com/jgf/concourse-tutorial/tree/master/16_run_tests_before_deploy)
* [20 - Versions and build numbers](https://github.com/jgf/concourse-tutorial/tree/master/20_versions_and_buildnumbers)
...
```
git clone https://github.com/jgf/concourse-tutorial.git
...
- name: resource-tutorial
  type: git
  source:
    uri: https://github.com/jgf/concourse-tutorial.git
```
